...
export const CLIENT_ID = ""; // GAPI CLIENT ID
export const GOOGLE_MAPS_API_KEY = ""; // GOOGLE MAPS API KEY
export const AWS_SERVER_DOMAIN = "<YOUR HTTPS FLASK SERVER URL HERE>"; // HTTPS FLASK SERVER URL
export const HOST_NAME = "<>"; // DEPLOYED REACT APP URL
export const UA_LOGIN = "<YOUR UNAUTHORISED LOGIN PAGE URL HERE>"; // UNAUTHORIZED LOGIN PAGE URL
